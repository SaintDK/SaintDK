<h1>О себе</h1>
<h2>Специалист в области машинного обучения с опытом разработки моделей для различных компаний. Работаю над проектами, требующими глубокого понимания как алгоритмов, так и предметной области, что позволяет мне создавать эффективные и инновационные решения на заказ.</h2>
